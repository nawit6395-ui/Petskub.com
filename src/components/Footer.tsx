        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground font-prompt">
              เว็บไซต์สื่อกลางสำหรับคนรักสัตว์ พื้นที่สำหรับหาบ้านให้หมา หาบ้านให้แมว และสัตว์เลี้ยงอื่นๆ<br />
              มุ่งมั่นลดปัญหาสัตว์จรจัดในสังคมไทย เชื่อมโยงผู้ให้และผู้รับเลี้ยงเข้าด้วยกัน ครอบคลุมพื้นที่กรุงเทพฯ ปทุมธานี และทั่วประเทศ
            </p>
          </div>
